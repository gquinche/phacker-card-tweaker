...
WIDGET_PATHS: dict[str, tuple[str, ...]] = {
    ...
    "card_screen_shadows": ("card", "screen_shadows"),
    "card_screen_paper_texture": ("card", "screen_paper_texture"),
    "card_screen_warm_creases": ("card", "screen_warm_creases"),
    "dpi": ("dpi",),
    "hatch_lw": ("hatch_lw",),
    ...
    "print_pdf_renderer": ("print", "pdf_renderer"),
    "print_cmyk_profile_path": ("print", "cmyk_profile_path"),
